...
struct CONSTANT_BUFFER0 
{
	...
	DirectX::XMFLOAT3 packing_bytes0; // 3x4 bytes = 12 bytes
	float scale; // 4 Bytes
	DirectX::XMFLOAT3 packing_bytes1; // 3x4 bytes = 12 bytes
};
...
const char g_TutorialName[100] = "Tutorial 04 Exercise 01\0";
...
POS_COL_VERTEX g_pVertices[] =
{
	...
	{ DirectX::XMFLOAT3(-0.9f, 0.9f, 0.0f), DirectX::XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) },
	{ DirectX::XMFLOAT3(0.1f, 0.9f, 0.0f), DirectX::XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f) },
	{ DirectX::XMFLOAT3(-0.9f, -0.45f, 0.0f), DirectX::XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f) }
};
...
HRESULT InitialiseGraphics(void)
{
	...
	bufferDesc.ByteWidth = sizeof(POS_COL_VERTEX) * 6; // Buffersize has space for ! 3 ! vertices
	...
	constant_buffer_desc.ByteWidth = 16; // Must be multiple of 16, calculate from CB struct
